...
class AccessMethods
{
     ...
     */
    public function get_categories($expand = [], $query_params = [])
    {
     ...
     */
    public function get_category($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_subcategories($expand = [], $query_params = [])
    {
     ...
     */
    public function get_subcategory($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_search($expand = [], $query_params = [])
    {
     ...
     */
    public function get_event($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event($id, $data = [])
    {
     ...
     */
    public function post_event_publish($id, $data = [])
    {
     ...
     *        unpublish.
     */
    public function post_event_unpublish($id, $data = [])
    {
     ...
     */
    public function post_event_cancel($id, $data = [])
    {
     ...
     */
    public function delete_event($id, $data = [])
    {
     ...
     */
    public function get_event_display_settings($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_display_settings($id, $data = [])
    {
     ...
     */
    public function get_event_ticket_classes($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_ticket_classes($id, $data = [])
    {
     ...
     *        ``ticket_class``.
     */
    public function get_event_ticket_class($id, $ticket_class_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_ticket_class($id, $ticket_class_id, $data = [])
    {
     ...
     */
    public function delete_event_ticket_class($id, $ticket_class_id, $data = [])
    {
     ...
     */
    public function get_event_canned_questions($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_questions($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_question($id, $question_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_attendees($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_attendee($id, $attendee_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_orders($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_discounts($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_discounts($id, $data = [])
    {
     ...
     */
    public function get_event_discount($id, $discount_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_discount($id, $discount_id, $data = [])
    {
     ...
     */
    public function get_event_public_discounts($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_public_discounts($id, $data = [])
    {
     ...
     */
    public function get_event_public_discount($id, $discount_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_public_discount($id, $discount_id, $data = [])
    {
     ...
     */
    public function delete_event_public_discount($id, $discount_id, $data = [])
    {
     ...
     */
    public function get_event_access_codes($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_event_access_codes($id, $data = [])
    {
     ...
     */
    public function get_event_access_code($id, $access_code_id, $expand = [], $query_params = [])
    {
     ...
     *        key ``access_code``.
     */
    public function post_event_access_code($id, $access_code_id, $data = [])
    {
     ...
     */
    public function get_event_transfers($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_teams($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_team($id, $team_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_event_teams_attendees($id, $team_id, $expand = [], $query_params = [])
    {
     ...
     *        .. _get-series-by-id:
     */
    public function post_series($data = [])
    {
     ...
     *        .. _post-series-by-id:
     */
    public function get_one_series($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_one_series($id, $data = [])
    {
     ...
     */
    public function post_series_publish($id, $data = [])
    {
     ...
     */
    public function post_series_unpublish($id, $data = [])
    {
     ...
     */
    public function post_series_cancel($id, $data = [])
    {
     ...
     *        .. _get-series-events:
     */
    public function delete_one_series($id, $data = [])
    {
     ...
     *        .. _post-series-dates:
     */
    public function get_series_events($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_series_events($id, $data = [])
    {
     ...
     */
    public function get_formatss($expand = [], $query_params = [])
    {
    ...
    public function get_formats($id, $expand = [], $query_params = [])
    {
     ...
     *        .. _get-media-upload:
     */
    public function get_media($id, $expand = [], $query_params = [])
    {
     ...
     *        .. _post-media-upload:
     */
    public function get_media_upload($expand = [], $query_params = [])
    {
     ...
     */
    public function get_order($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_organizers($data = [])
    {
     ...
     */
    public function get_organizer($id, $expand = [], $query_params = [])
    {
     ...
     *        The Facebook URL cannot be a group page.
     */
    public function post_organizer($id, $data = [])
    {
     ...
     */
    public function get_organizers_events($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_refund_request($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_refund_request($id, $data = [])
    {
    ...
    public function post_refund_requests($data = [])
    {
     ...
     */
    public function get_reports_sales($expand = [], $query_params = [])
    {
     ...
     */
    public function get_reports_attendees($expand = [], $query_params = [])
    {
     ...
     */
    public function get_system_timezones($expand = [], $query_params = [])
    {
     ...
     */
    public function get_system_regions($expand = [], $query_params = [])
    {
     ...
     */
    public function get_system_countries($expand = [], $query_params = [])
    {
     ...
     */
    public function post_tracking_beacons($data = [])
    {
     ...
     */
    public function get_tracking_beacon($tracking_beacons_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_tracking_beacon($tracking_beacons_id, $data = [])
    {
     ...
     */
    public function delete_tracking_beacon($tracking_beacons_id, $data = [])
    {
     ...
     */
    public function get_event_tracking_beacons($event_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_tracking_beacons($user_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_orders($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_organizers($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_owned_events($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_events($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_venues($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_user_owned_event_attendees($id, $expand = [], $query_params = [])
    {
     ...
     *        (events that would be returned from ``/users/:id/owned_events/``)
     */
    public function get_user_owned_event_orders($id, $expand = [], $query_params = [])
    {
     ...
     *        ``contact_lists``.
     */
    public function get_user_contact_lists($id, $expand = [], $query_params = [])
    {
     ...
     *        ``contact_list``.
     */
    public function post_user_contact_lists($id, $data = [])
    {
     ...
     */
    public function get_user_contact_list($id, $contact_list_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_user_contact_list($id, $contact_list_id, $data = [])
    {
     ...
     */
    public function delete_user_contact_list($id, $contact_list_id, $data = [])
    {
     ...
     *        as ``contacts``.
     */
    public function get_user_contact_lists_contacts($id, $contact_list_id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_user_contact_lists_contacts($id, $contact_list_id, $data = [])
    {
     ...
     * =======
     */
    public function delete_user_contact_lists_contacts($id, $contact_list_id, $data = [])
    {
     ...
     */
    public function get_user_bookmarks($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_user_bookmarks_save($id, $data = [])
    {
     ...
     */
    public function post_user_bookmarks_unsave($id, $data = [])
    {
     ...
     */
    public function get_venue($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function post_venue($id, $data = [])
    {
     ...
     *        ..start-internal
     */
    public function post_venues($data = [])
    {
     ...
     *        ..end-internal
     */
    public function get_venues_search($expand = [], $query_params = [])
    {
     ...
     */
    public function get_venues_events($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function get_webhook($id, $expand = [], $query_params = [])
    {
     ...
     */
    public function delete_webhook($id, $data = [])
    {
     ...
     */
    public function get_webhooks($expand = [], $query_params = [])
    {
    ...
    public function post_webhooks($data = [])
    {
